                        ...
                        <div className='d-flex justify-content-center'>
                            <div className='d-flex'>
                                <div className='d-flex align-items-center' style={{ padding: '10px', borderRadius: '40px', backgroundColor: 'black' }}>
                                    ...
                                    <div>
                                        <p className='my-auto' style={{ fontSize: '10px' }}><span style={{ fontWeight: 'bold', color: '#ffff' }}>GET IT ON </span><br /><span style={{ color: 'gray' }}>GOOGLE PLAY</span></p>
                                    </div>


                                </div>
                                <div className='d-flex align-items-center' style={{ padding: '10px', borderRadius: '40px', backgroundColor: 'black', border: '1px solid yellow' }}>
                                    <div className='me-2' >
                                        <img className='' src={apple} alt='Play store' />
                                    </div>
                                    <div>
                                        <p className='my-auto' style={{ fontSize: '10px' }}><span style={{ color: 'gray' }} >Available on the </span><br /><span style={{ fontWeight: 'bold', color: '#ffff' }}>Apple Store</span></p>
                                    </div>
